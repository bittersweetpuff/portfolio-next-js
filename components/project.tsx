...
export default function Project({ title, description, tags, imageUrl}: ProjectProps) {
  ...
  <motion.div
    ref={ref}
      ...
      <section className = "bg-gray-100 max-w-[42rem] rounded-lg border border-black/5 overflow-hidden sm:pr-8 relative sm:h-[20rem] hover:bg-gray-200 transition dark:bg-white/10 dark:hover:bg-white/20">
      ...
      <Image src = {imageUrl} alt = "Project tumbnail" quality = {95} 
